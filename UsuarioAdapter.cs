    ...
    public class UsuarioAdapter:Adapter
    {
        ...
        public void Update(Usuario usuario)
        {
            try
            {
                ...
                cmdSave.Parameters.Add("@id", SqlDbType.VarChar, 50).Value = usuario.ID;
        ...
        public void Insert(Usuario usuario)
        {
            ...
            {
                this.OpenConnection();
                SqlCommand cmdSave = new SqlCommand("INSERT INTO usuarios(nombre_usuario, clave, habilitado, nombre, apellido, email, id_persona) values (@nombre_usuario, @clave, @habilitado, @nombre, @apellido, @email, @id_per) select @@identity", sqlConn);
                ...
                cmdSave.Parameters.Add("@apellido", SqlDbType.VarChar, 50).Value = usuario.Apellido;
                cmdSave.Parameters.Add("@email", SqlDbType.VarChar, 50).Value = usuario.Email;
                cmdSave.Parameters.Add("@id_per", SqlDbType.Int).Value = usuario.IDPersona;
         ...
         public Business.Entities.Usuario Login(string user, string pass)
        {
            Usuario usr = new Usuario();
            try
            {
                this.OpenConnection();   
                SqlCommand cmdUsuarios = new SqlCommand("select * from usuarios where nombre_usuario=@user and clave=@pass", sqlConn);
