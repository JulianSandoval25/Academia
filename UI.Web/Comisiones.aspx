...
<asp:Content ID="Content1" ContentPlaceHolderID="bodyContentPlaceHolder" runat="server">
    ...
    <asp:Panel ID="formPanel" Visible="false" runat="server" align="center" >
        ...
        <br />
        <asp:Label ID="lblAnio" runat="server" Text="Año Especial"></asp:Label><asp:TextBox ID="txtAnioEspecialidad" runat="server"></asp:TextBox>
        <asp:Label ID="lblAnio2" runat="server" Text="Año invalido" Visible="false" ForeColor="#FF3300"></asp:Label>
        <br />
