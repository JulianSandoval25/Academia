...
<asp:Content ID="Content2" ContentPlaceHolderID="bodyContentPlaceHolder" runat="server">
    <asp:Panel ID="Panel2" runat="server" style="margin-left: 64px" >
        ...
        <h1 align="center"  class="auto-style1">Planes</h1>
            </asp:Panel>
    ...
    <asp:Panel ID="formPanel" Visible="false" runat="server" align="center">
        ...
        <asp:Label ID="lblDescripcion2" runat="server" Text="Descripcion invalido" Visible="false" ForeColor="#FF3300"></asp:Label><br />
        <asp:Label ID="lblEspecialidad" runat="server" Text="Especialidad"></asp:Label><asp:DropDownList ID="ddlEspecialidad" runat="server" ></asp:DropDownList><br />
